<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\phpstudy\PHPTutorial\WWW\show\public/../application/admin\view\main\index.html";i:1524468187;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
                ...
                <div carousel-item="">
                  <ul class="layui-row layui-col-space10 layui-this">
                    ...
                    <li class="layui-col-xs6">
                      <a lay-href="" class="layadmin-backlog-body">
                        <h3>文章</h3>
                        <p><cite><?php echo $web['article_num']; ?></cite></p>
                      </a>
                    </li>
                    <li class="layui-col-xs6">
                      <a lay-href="" class="layadmin-backlog-body">
    ...
    <div class="layui-col-md4">
          ...
          <table class="layui-table">
            ...
            <tbody>
              <tr>
                ...
                <td>
                   <?php echo $info['show']; ?>
                    <a href="http://showoow.com" target="_blank" style="padding-left: 15px;">更新日志</a> 
                </td>
              </tr>
              <tr>
                <td>基于框架</td>
      ...
      <div class="layui-card">
        ...
        <div class="layui-card-body layui-text layadmin-text">
          <p>这个后台管理框架搭载的是国内最受欢迎的两大框架Layui和ThinkPHP，ThinkPHP的大道至简和Layui的简而全在理念上可谓是不谋而合，两大框架结合所产生的结果就是将WEB开发精简到了极致。</p>
        </div>
      </div>
