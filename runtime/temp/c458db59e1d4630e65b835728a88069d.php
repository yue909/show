<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"D:\phpstudy\PHPTutorial\WWW\show\public/../application/admin\view\admin\personal.html";i:1524449759;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
    ...
    <form class="layui-form" id="admin">
      ...
      <div class="layui-upload" id="upload-thumb">
        ...
        <div class="layui-upload-list">
          ...
          <p id="demoText" style="margin-left:50px"></p>
        </div>
      </div>
      ...
      layui.use(['layer', 'form'], function() {
          ...
          $(window).on('load', function() {
              form.on('submit(admin)', function(data) {
                  $.ajax({
                      url:"<?php echo url('admin/admin/personal'); ?>",
